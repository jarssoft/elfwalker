...
namespace tekoaly {
    /**
    Taulukko, joka sisältää agentin kaikkien
    lihaksien liikkeet tietyllä aikavälillä.
    Sisältää geneettisen päättelijän, joka tallentaa
    onnistuneet suunnitelmat iteratiivisesti
    uusiin taulukoihin.

    Optimointikeinot:
    - Mutatoitavien sisarusten määrä riippuu yhteisestä menestyksestä.
    */
    class Liiketaulukko {
